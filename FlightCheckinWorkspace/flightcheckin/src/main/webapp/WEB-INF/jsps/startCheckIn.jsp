...
<body>
<!-- <div align="center">
<h1>Start CheckIn</h1><br/>
<form action="startCheckIn" method="post">
Enter the reservation Id:<input type="text" name="reservationId"/><br/><br/>
...
<div align="center">
<h1>Welcome to Flight Check-In Application</h1><br/>

<h3>Start CheckIn</h3><br/>
<form class="form-inline" action="startCheckIn" method="post" style="margin-left: 400px">

  <label for="rid">Enter the reservation Id:</label>
  <input type="text" id="rid" placeholder="Reservation Id" name="reservationId" required/>
